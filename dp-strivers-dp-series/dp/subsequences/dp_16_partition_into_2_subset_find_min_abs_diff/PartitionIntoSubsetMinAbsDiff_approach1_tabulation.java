 ...
 */
public class PartitionIntoSubsetMinAbsDiff_approach1_tabulation {

    // Time: O(n*target), Space: O(n*target) as dp array is of size n*target where target is sum of all elements in array
    public static void main(String[] args) {
        // test 1
        int n1 = 3;
        int[] arr1 = new int[]{8, 6, 5};
        System.out.println(new PartitionIntoSubsetMinAbsDiff_approach1_tabulation().minSubsetSumDifference(arr1, n1)); // 3

        // test 2
        int n2 = 2;
        int[] arr2 = new int[]{1, 6};
        System.out.println(new PartitionIntoSubsetMinAbsDiff_approach1_tabulation().minSubsetSumDifference(arr2, n2)); // 5

        // test 3
        int n3 = 2;
        int[] arr3 = new int[]{11, 12};
        System.out.println(new PartitionIntoSubsetMinAbsDiff_approach1_tabulation().minSubsetSumDifference(arr3, n3)); // 1

        // test 4
        int n4 = 3;
        int[] arr4 = new int[]{9, 15, 14};
        System.out.println(new PartitionIntoSubsetMinAbsDiff_approach1_tabulation().minSubsetSumDifference(arr4, n4)); // 8
    }
