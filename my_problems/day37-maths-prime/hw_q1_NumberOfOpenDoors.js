...
const findNoOfOpenDoors = (N) => {
    // observation is there would be sqrt(N) doors open after all the nos are done with their turn
...
findNoOfOpenDoors(5);
findNoOfOpenDoors(6);
findNoOfOpenDoors(100);
findNoOfOpenDoors(150);
findNoOfOpenDoors(101);
findNoOfOpenDoors(50);