 ...
 * ball "forward" to player with id = ID.
 ...
 * The second argument of the input contains the number B ( id of the player
 * possessing the ball in the very beginning).
...
/**
 * Implement the stack and return top of stack
 * If 0 is found, pop the element from stack
 * TC: O(N)
 */
public class hw_q3_PassingGame {

    public static int solve(int A, int B, int[] C) {
        // implement the stack and after N passes return element from stack top
    ...
    public static void main(String[] args) {
        System.out.println(solve(10, 23, new int[] { 86, 63, 60, 0, 47, 0, 99, 9, 0, 0 })); // expected output 63
        System.out.println(solve(1, 1, new int[] { 2 })); // expected output 2
    }
