 ...
 * if no of factors are same, then sort according to magnitude
 */
...
const sortBasedOnFactors = (A) => {
    ...
    A.sort(function(a, b) {
        ...
        // if no of factors are same, sort according to magnitude
        if (x === y) {
            return a - b;
        }
...
sortBasedOnFactors([17, 25, 32, 12, 45, 34, 90, 18, 8, 3, 7]);